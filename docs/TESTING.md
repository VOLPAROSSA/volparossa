...
to the Client lease. The hook requires the echo reply, a non-zero handshake and strict RX/TX growth
on both WireGuard peer views. It then deletes the temporary relay interface and route, proves exact
